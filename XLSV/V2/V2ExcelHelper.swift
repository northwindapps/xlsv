...
class V2ExcelHelper{
    ...
    func isCellInsideRange(cell: String, startCell: String, endCell: String) -> Bool {
        ...
        let startColumnInt = V2ExcelHelper().columnToInt(V2ExcelHelper().alphabetOnlyString(text: startCell)) ?? 0
        let startRowInt = Int(V2ExcelHelper().numberOnlyString(text: startCell)) ?? 0
        let endColumnInt = V2ExcelHelper().columnToInt(V2ExcelHelper().alphabetOnlyString(text: endCell)) ?? 0
        let endRowInt = Int(V2ExcelHelper().numberOnlyString(text: endCell)) ?? 0
