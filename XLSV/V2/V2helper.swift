...
class V2XMLParserHelper: NSObject, XMLParserDelegate {
...
class V2CustomXMLParserDelegate: V2XMLParserHelper {
...
class V2SharedStringsUniqueCountParserDelegate: V2XMLParserHelper {
...
class V2SharedStringsParserDelegate: V2XMLParserHelper {
    // Class variables
