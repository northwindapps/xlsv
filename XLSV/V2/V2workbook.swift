...
class V2Workbook {
    ...
    func sheetGenerator(id:Int){
        sheet.append("<sheet name=\"V2Sheet" + String(id) + "\" sheetId=\"" + String(id) + "\" r:id=\"rId" + String(id) + "\"/>")
    }
    ...
    func export(sheetSize:Int){
       ...
       for i in 0..<sheet.count {
        ...
        xml.append("</workbook>")
            ...
            FileManager.default.v2WriteXmlsandBox(folder: "xl/", filename: "workbook.xml", content: xml)
        }
}
